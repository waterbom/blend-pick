  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-5 mb-4">
        <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">구매자</h2>
        <div className="grid grid-cols-2 gap-y-3 text-sm">
          ...
          <div className="col-span-2">
            ...
            <p className="font-medium text-gray-800">{order.buyer_email ?? "-"}</p>
          </div>
        </div>
      </div>
      ...
      {/* 배송지 */}
      <div className="bg-white rounded-xl border border-gray-100 p-5 mb-4">
        <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">배송지</h2>
        <div className="text-sm space-y-1.5">
          ...
          {order.addr_memo && (
            <p className="text-gray-400 text-xs mt-2">배송 메모: {order.addr_memo}</p>
          )}
        </div>
      </div>
      ...
      {/* 주문 상품 */}
      <div className="bg-white rounded-xl border border-gray-100 p-5 mb-4">
        <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">주문 상품</h2>
        ...
        <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
          <div className="text-xs text-gray-400 space-y-1">
            ...
            <p>결제일: {order.paid_at ? new Date(order.paid_at).toLocaleString("ko-KR") : "-"}</p>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-400">배송비 {Number(order.shipping_fee ?? 0).toLocaleString()}원 포함</p>
