    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-0.5">
          공구별/자사몰 손익 — 순이익 = 총매출 − 부가세 − 공급가 − 배송비 − PG수수료 − 기타비용 − 수수료
        </p>
      </div>
      ...
      <p className="text-xs text-gray-400 mt-4">
        ...
        <br />· 호텔 공구: 대행 모델 배분 — 공급가(호텔 정산분) 88% · 인플루언서 수수료 5%(귀속 주문만) · 블렌드픽 7%. 순이익 = 7% − 토스 수수료 1.7% = 매출의 5.3% (직접 유입 주문은 인플 몫이 남아 더 높아짐). 인플루언서 지급은 [공구 정산]에서 실행됩니다.
      </p>
    </div>
  );
}
