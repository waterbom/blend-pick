...
before(async()=>{
 ...
 for (const [table,cols] of Object.entries({
   ...
   orders:{campaign_id:'uuid',tracking_company:'text',tracking_number:'text',order_number:'text',user_id:'uuid',buyer_name:'text',buyer_phone:'text',buyer_email:'text',recipient_name:'text',recipient_phone:'text',addr_zipcode:'text',addr_address:'text',addr_detail:'text',addr_memo:'text',shipping_fee:'int',payment_method:'text',influencer_id:'uuid',influencer_name:'text',commission_rate:'numeric',cancelled_at:'timestamptz',updated_at:'timestamptz'},
